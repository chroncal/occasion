        ...
        while change_num < 1:  # 默认至少有一种数据增强生效
            ...
            if self.is_changeLight:
                if random.random() > 0:  # 改变亮度
                    ...
                    b,g,r = cv2.split(img)
                    scale = np.random.uniform(20, 60)
                    g = cv2.add(g,scale)
                    r = cv2.add(r,int(scale*1.4))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'C:\Users\Meow_Sakura\Desktop\1234')
    parser.add_argument('--source_xml_path', type=str, default=r'C:\Users\Meow_Sakura\Desktop\1235')
    parser.add_argument('--save_img_path', type=str, default=r'C:\Users\Meow_Sakura\Desktop\1234')
    parser.add_argument('--save_xml_path', type=str, default=r'C:\Users\Meow_Sakura\Desktop\1235')
